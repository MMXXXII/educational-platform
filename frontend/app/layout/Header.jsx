...
import { UserIcon, ArrowRightEndOnRectangleIcon, BookOpenIcon, PencilSquareIcon, Bars3Icon, XMarkIcon } from '@heroicons/react/24/outline';
                    ...
                    <nav className="hidden md:flex space-x-4 items-center">
                        {isAuthenticated ? (
                            <>
                                ...
                                <Link to="/editor" className="text-gray-700 hover:text-blue-600 flex items-center">
