        ...
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {skeletonCards.map((_, index) => (
                    <div key={index} className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700/50 overflow-hidden">
                        ...
                        <div className="p-4">
                            ...
                            <div className="h-6 w-full bg-gray-200 dark:bg-gray-700 rounded mb-3 animate-pulse"></div>
