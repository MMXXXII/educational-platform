    ...
    const features = [
        {
            ...
            icon: <LightBulbIcon className="h-10 w-10 sm:h-12 sm:w-12 text-yellow-500" />,
            imagePosition: 'right'
        },
        {
            ...
            icon: <PuzzlePieceIcon className="h-10 w-10 sm:h-12 sm:w-12 text-green-500" />,
            imagePosition: 'left'
        }
    ];
                        ...
                        >
                            ...
                            <div className="flex-1 flex justify-center w-full md:w-auto">
                                <div className="bg-gray-200 w-full aspect-video rounded-lg flex items-center justify-center">
                                    <p className="text-gray-500 text-sm">Изображение будет добавлено позже</p>
                                </div>
                            </div>
                        </div>
                    ))}
