...
export function UserProfile() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-gray-100 py-12 px-4 sm:px-0">
            <div className="max-w-md mx-auto">
                ...
                <div className="bg-gray-800 p-8 rounded-lg shadow-lg flex flex-col items-center">
                    ...
                    {user?.role === 'admin' && (
                        <RouterLink
                            to="/admin"
                            className="flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors mb-4"
                        >
